                ...
                >
                  ...
                  >
                    ...
                    <Avatar className="w-full h-full">
                      <AvatarImage src="/headshot.JPG" alt="Jacob Christensen" className="object-cover object-center" />
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {technologies.map((tech) => (
                      <span key={tech} className="rounded-full bg-white/5 px-3 py-1 text-sm text-white/80">
                        {tech}
                      </span>
                    ))}
                  </div>
